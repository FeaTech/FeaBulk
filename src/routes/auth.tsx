  ...
  async function submit(event: FormEvent) {
    ...
    try {
      if (mode === "sign_up") {
        ...
        const { data, error } = await supabase.auth.signUp({ email, password, options: { data: { full_name: fullName, phone_e164: phone, requested_workspace: type, legal_business_name: legalBusinessName, trading_name: tradingName, business_type: businessType, gstin, registered_address: registeredAddress, operating_address: registeredAddress } } });
